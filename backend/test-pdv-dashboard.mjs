...
async function test() {
  try {
    ...
    console.log(`Testing GET /api/v1/companies/${companyId}/pdv/dashboard...`);
    
    // I need an auth token first
    ...
    const res = await axios.get(`http://localhost:3001/api/v1/companies/${companyId}/pdv/dashboard`, {
