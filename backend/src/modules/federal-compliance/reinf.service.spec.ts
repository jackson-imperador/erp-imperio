...
describe("ReinfService (Business Validation)", () => {
  let instance: ReinfService;
  ...
  it("should execute business logic for generateEvent", async () => {
    if (!instance.generateEvent) return;
    try {
      const result = await instance.generateEvent(
