...
describe("CompanyService (Business Validation)", () => {
  let instance: CompanyService;
  ...
  it("should execute business logic for update", async () => {
  ...
  it("should execute business logic for getSettings", async () => {
    if (!instance.getSettings) return;
    try {
  ...
  it("should execute business logic for updateSettings", async () => {
    if (!instance.updateSettings) return;
    try {
