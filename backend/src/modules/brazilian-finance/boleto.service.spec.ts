...
describe("BoletoService (Business Validation)", () => {
  let instance: BoletoService;
  ...
  it("should execute business logic for createBoleto", async () => {
    if (!instance.createBoleto) return;
    try {
      const result = await instance.createBoleto(
