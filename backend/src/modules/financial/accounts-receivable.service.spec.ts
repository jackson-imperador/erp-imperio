...
describe("AccountsReceivableService (Business Validation)", () => {
  let instance: AccountsReceivableService;
  ...
  beforeAll(() => {
    ...
    try {
      instance = new AccountsReceivableService(
        prisma as any,
        eventEmitter as any,
        genericMock as any,
        genericMock as any,
  ...
  it("should execute business logic for pay", async () => {
    if (!instance.pay) return;
    try {
      const result = await instance.pay(
        { companyId: "test" } as any,
        { id: "test" } as any,
        {} as any,
        {} as any,
