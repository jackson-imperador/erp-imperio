...
describe("NotificationService (Business Validation)", () => {
  ...
  it("should execute business logic for send", async () => {
    if (!instance.send) return;
    try {
  ...
  it("should execute business logic for handleSaleConfirmed", async () => {
    if (!instance.handleSaleConfirmed) return;
    try {
      const result = await instance.handleSaleConfirmed(
        { companyId: "test" } as any,
        { id: "test" } as any,
        {} as any,
        {} as any,
