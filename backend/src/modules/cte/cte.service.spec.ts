...
describe("CteService (Business Validation)", () => {
  let instance: CteService;
  ...
  it("should execute business logic for issueCte", async () => {
    if (!instance.issueCte) return;
    try {
      const result = await instance.issueCte(
