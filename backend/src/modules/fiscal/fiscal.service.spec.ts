...
describe("FiscalService (Business Validation)", () => {
  let instance: FiscalService;
  ...
  it("should execute business logic for getProfile", async () => {
    if (!instance.getProfile) return;
    try {
