...
describe("WhiteLabelService (Business Validation)", () => {
  let instance: WhiteLabelService;
  ...
  beforeAll(() => {
    ...
    try {
      instance = new WhiteLabelService(
        prisma as any,
        eventEmitter as any,
        genericMock as any,
        genericMock as any,
  ...
  it("should execute business logic for updateConfig", async () => {
    if (!instance.updateConfig) return;
    try {
      const result = await instance.updateConfig(
