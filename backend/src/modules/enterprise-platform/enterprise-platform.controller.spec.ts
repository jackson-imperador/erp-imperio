...
describe("EnterprisePlatformController (Business Validation)", () => {
  let instance: EnterprisePlatformController;
  ...
  beforeAll(() => {
    ...
    try {
      instance = new EnterprisePlatformController(
        prisma as any,
        eventEmitter as any,
        genericMock as any,
        genericMock as any,
  ...
  it("should execute business logic for getOpenApi", async () => {
    if (!instance.getOpenApi) return;
    try {
      const result = await instance.getOpenApi(
