...
describe("SdkService (Business Validation)", () => {
  let instance: SdkService;
  ...
  it("should execute business logic for generateOpenApiSpec", async () => {
    if (!instance.generateOpenApiSpec) return;
    try {
      const result = await instance.generateOpenApiSpec(
