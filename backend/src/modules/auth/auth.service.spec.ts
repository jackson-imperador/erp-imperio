...
describe("AuthService (Business Validation)", () => {
  ...
  it("should execute business logic for login", async () => {
  ...
  it("should execute business logic for register", async () => {
  ...
  it("should execute business logic for refreshTokens", async () => {
    if (!instance.refreshTokens) return;
    try {
