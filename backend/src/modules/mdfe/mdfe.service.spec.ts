...
describe("MdfeService (Business Validation)", () => {
  let instance: MdfeService;
  ...
  it("should execute business logic for issueMdfe", async () => {
    if (!instance.issueMdfe) return;
    try {
      const result = await instance.issueMdfe(
