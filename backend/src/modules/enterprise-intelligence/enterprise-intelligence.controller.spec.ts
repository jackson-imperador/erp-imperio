...
describe("EnterpriseIntelligenceController (Business Validation)", () => {
  let instance: EnterpriseIntelligenceController;
  ...
  beforeAll(() => {
    ...
    try {
      instance = new EnterpriseIntelligenceController(
        prisma as any,
        eventEmitter as any,
        genericMock as any,
        genericMock as any,
