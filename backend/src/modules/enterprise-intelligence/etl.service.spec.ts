...
describe("EtlService (Business Validation)", () => {
  ...
  it("should execute business logic for runPipeline", async () => {
    if (!instance.runPipeline) return;
    try {
      const result = await instance.runPipeline(
