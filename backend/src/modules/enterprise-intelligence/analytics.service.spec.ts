...
describe("AnalyticsService (Business Validation)", () => {
  ...
  it("should execute business logic for getExecutiveDashboard", async () => {
    if (!instance.getExecutiveDashboard) return;
    try {
      const result = await instance.getExecutiveDashboard(
