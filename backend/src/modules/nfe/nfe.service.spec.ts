...
describe("NfeService (Business Validation)", () => {
  let instance: NfeService;
  ...
  it("should execute business logic for issueNfe", async () => {
    if (!instance.issueNfe) return;
    try {
      const result = await instance.issueNfe(
