...
export default function CentrosdeCustoPage() {
  const { items, isLoading, create, update, remove, isMutating } = useCrud<any>('/cost-centers', ['centros-custo']);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Gestão de Centros de Custo</h1>
      ...
      <GenericDialog 
        ...
        title={editingItem ? 'Editar Centros de Custo' : 'Novo Centros de Custo'}
      >
