...
export default function EmpresasPage() {
  const { items, isLoading, create, update, remove, isMutating } = useCrud<any>('/companies', ['empresas']);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Gestão de Empresas</h1>
      ...
      <GenericDialog 
        ...
        title={editingItem ? 'Editar Empresas' : 'Novo Empresas'}
      >
