...
export default function PerfiseRBACPage() {
  const { items, isLoading, create, update, remove, isMutating } = useCrud<any>('/roles', ['perfis']);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Gestão de Perfis e RBAC</h1>
      ...
      <GenericDialog 
        ...
        title={editingItem ? 'Editar Perfis e RBAC' : 'Novo Perfis e RBAC'}
      >
